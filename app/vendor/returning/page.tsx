...
export default function ReturningPage() {
  ...
  const handleAction = (order: Order) => {
    alert(`Demo: Order ${order.id} â†’ package received. Moving to "Pending Verdict" for inspection.`);
  };

  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-xl md:text-2xl font-bold text-[#111111]">Currently Returning</h1>
