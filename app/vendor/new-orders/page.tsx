...
export default function NewOrdersPage() {
  ...
  const handleAction = (order: Order, _action: string) => {
    alert(`Demo: Order ${order.id} → marked as "Dispatched". It will move to Shipping.`);
  };
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[#111111]">New Orders</h1>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          { label: "Avg. Order Value", value: orders.length ? `LKR ${Math.round(orders.reduce((s, o) => s + o.total, 0) / orders.length).toLocaleString()}` : "—", color: "#999999" },
